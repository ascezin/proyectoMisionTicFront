<template>
    <div class="Titulos">
        <h1>¡Bienvenido <span class="user"> {{username}} </span>! a usuarios</h1>
        <h4>En esta seccion podras agregar, consultar, elminar, actualizar usuarios</h4>
    </div>
    <br>
    <br>
    <div class="cantainer">
